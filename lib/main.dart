...
class IntroWidget extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
   return ElevatedButton(onPressed: ()=>{
     Navigator.push(context, MaterialPageRoute(builder: (context)=>WidgetsIntro(title: 'Introduction Widget')))
...
class LayoutWidget extends StatelessWidget{
  @override
  Widget build(BuildContext context) {
    return ElevatedButton(onPressed: ()=>{}, child: Text('Layout Widget'));
  }
}
class NavigationWidget extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return ElevatedButton(onPressed: ()=>{
      Navigator.push(context, MaterialPageRoute(builder: (context)=>NavigationRouteWidget(title: 'Navigation Widget')))
...
class AppStateMangementWidget extends StatelessWidget{
  @override
  Widget build(BuildContext context) {
    return ElevatedButton(onPressed: ()=>{}, child: Text('AppStateMangement Widget'));
  }
}
  ...
  Widget build(BuildContext context) {
    return
      ListTile(
        ...
        leading: CircleAvatar(child: Text(widget.items[0][0]),backgroundColor: inCart ? Colors.blue : Colors.grey,),
        title: Text(widget.items[0], style: TextStyle(
     ...
     ListView(
      children: widget.items
          .map((e) => ListTile(
                ...
                title: Text(e,style: TextStyle(color: inCart?Colors.blue:Colors.grey,decoration: inCart ?TextDecoration.lineThrough:null),),
              ))
          .toList(),
...
class NavigationRouteWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(title: Text('Navigation Widget'),),
    body:
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        home: Scaffold(
            ...
            body: Center(
                child: GestureDetector(onTap: () => {goBack(context)},
                  child: Container(
                    padding: EdgeInsets.all(10.0), child: Text("Go Back"),),
                ))));
  }
